...
urlpatterns = [
    ...
    path("rag/business-plan-refine", views.public_business_plan_refine),
    path("rag/business-plan-template-inspect", views.public_business_plan_template_inspect),
    path("rag/business-plan-render", views.public_business_plan_render),
